...
const Kuis2 = () => {
  ...
  const questions = [
    { id: 1, text: 'Dalam binary tree, setiap node bisa memiliki lebih dari dua child.', answer: false },
    { id: 2, text: 'Node yang tidak memiliki child disebut Leaf.', answer: true },
    { id: 3, text: 'Subtree adalah bagian dari pohon yang terdiri dari sebuah node dan seluruh child-nya.', answer: true },
  ];
