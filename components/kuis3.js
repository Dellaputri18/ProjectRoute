...
const Kuis3 = () => {
  ...
  const questions = [
    { id: 1, text: 'Dalam Preorder traversal, Root dikunjungi terakhir.', answer: false },
    { id: 2, text: 'Inorder traversal mengunjungi node dalam urutan Left-Root-Right.', answer: true },
    { id: 3, text: 'Postorder traversal mengunjungi subtree kanan terlebih dahulu, baru subtree kiri.', answer: false },
  ];
