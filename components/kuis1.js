...
const Kuis1 = () => {
  ...
  const questions = [
    { id: 1, text: 'Node yang berada di puncak dari suatu pohon disebut Leaf.', answer: false },
    { id: 2, text: 'Setiap node di dalam pohon memiliki satu parent, kecuali Root.', answer: true },
    { id: 3, text: 'Leaf adalah node yang tidak memiliki child.', answer: true },
  ];
